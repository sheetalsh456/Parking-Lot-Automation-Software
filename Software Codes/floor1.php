...
<!--content goes here-->
<center>
<div style="font-weight:bold;font-size=80px;"><center> FLOOR 1</center></div>
		<br><br>
 		<table class="slots1">
...
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-3">Entry time(Hours/minutes)</div>
<div class="col-md-1">
<select name="entryh">
  <option value="9">9</option>
  <option value="10">10</option>
...
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-3">Exit time(Hours/minutes)</div>
<div class="col-md-1">
<select name="exith">
  <option value="9">9</option>
  <option value="10">10</option>
