...
if(isset($_POST['update']))
{
 ...
 $add1 = mysql_real_escape_string($_POST['add']);
 $age1 = mysql_real_escape_string($_POST['age']);
 $num1 = mysql_real_escape_string($_POST['num']);
    ...
    <div class="container-fluid">
      <div class="row main-div">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <br/><font style="font-size:18px; text-shadow:0 0 4px black; font-family: 'Roboto', sans-serif; font-weight:400;"><?php echo $row['Name'];?></font>
          </div>
            <div id="MainMenu">
			  ...
			  <div class="panel-body">
				...
				<div class="col-md-6"><strong>Name</strong></div>
					<div class="col-md-6">
				  			...
				  			<input type="text" name="name" placeholder="Name" value="<?=$name?>" class="box">
			  ...
			  <div class="panel-body">
				...
				<div class="col-md-6"><strong>Contact Number</strong></div>
					<div class="col-md-6">
				  			...
				  			<input type="text" name="num" placeholder="contact number" value="<?=$num?>" class="box">
			  ...
			  <div class="panel-body">
				...
				<div class="col-md-6"><strong>Address</strong></div>
					<div class="col-md-6">
				  			...
				  			<input type="text" name="add" placeholder="Address" value="<?=$add?>"  class="box">
                          ...
                          <div class="panel-body">
                                ...
                                <div class="col-md-6"><strong>User Name</strong></div>
                                        <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="uname" placeholder="Address" value="<?=$uname?>"  class="box">
			  ...
			  <div class="panel-body">
				...
				<div class="col-md-6"><strong>Age</strong></div>
					<div class="col-md-6">
				  		...
				  		<input type="number" name="age" placeholder="Age" value="<?=$age?>" class="box">
