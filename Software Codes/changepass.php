...
if($x == 2){
 if(mysql_query("UPDATE customer_details SET password ='$npass' WHERE user_id = $id"))
 {
  ?>
		...
		<div class="col-md-6">
			<div class="panel panel-default info">
			  <div class="panel-body">
			   	<div class="row">
				<div class="col-md-6"><strong>Old Password</strong></div>
					<div class="col-md-6">
				    		
				  			<input type="password" name="opass" placeholder="Previous password" value="" class="box">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="panel panel-default info">
			  <div class="panel-body">
			   	<div class="row">
				<div class="col-md-6"><strong>New Password</strong></div>
					<div class="col-md-6">
				    		
				  			<input type="password" name="npass" placeholder="New Password" value="" class="box">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="panel panel-default info">
			  <div class="panel-body">
			   	<div class="row">
				<div class="col-md-6"><strong>Confirm Password</strong></div>
					<div class="col-md-6">
				    		
				  			<input type="password" name="cpass" placeholder="Confirm password" value=""  class="box">
