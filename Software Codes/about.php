    ...
    <div class="container-fluid">
      <div class="row main-div">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <br/><font style="font-size:20px; text-shadow:0 0 4px black; font-family: 'Roboto', sans-serif; font-weight:bold;"><?php echo $userRow['Name']; ?></font>
          </div>
            <div id="MainMenu">
...
<div class="col-md-12" style="padding:20px;">
        ...
        <div><center><b>ParkWhizz</b></class></div><br>
	<div>We have made this application to facilitate online booking of parking slots for improved user convenience and efficiency. Our aim is to provide the ease of automation. In order to accomplish this mission, we will work for the betterment of this application to suit user requirements and demands. Please feel free to contact us for any queries/suggestions.</div><br>
	<div><center><b>Development Team</b></center></div><br>
	<div><center><ul><li>
    Navya R S<br>
    2nd year Btech CSE,<br>
    NITK Surathkal.<br>
    Email id: navy8296@gmail.com<br>
    </li><br>
    <li> Sheetal Shalini<br>
    2nd year Btech CSE,<br>
    NITK Surathkal.<br>
    Email id: sheetalsh456@gmail.com<br>
    </li><br>
<li> Moore Saranya<br>
    2nd year Btech CSE,<br>
    NITK Surathkal.<br>
    Email id: mooresaranya@gmail.com</li></ul></center></div></div>
<!--content ends here-->
  </div>
      </div>
    </div>
