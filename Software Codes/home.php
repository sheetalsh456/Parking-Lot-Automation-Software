...
$res=mysql_query("SELECT * FROM customer_details WHERE user_id=".$_SESSION['user']);
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <br/><font style="font-size:20px; text-shadow:0 0 4px black; font-family: 'Roboto', sans-serif; font-weight:bold;"><?php echo $row['Name']; ?></font>
            ...
            <div class="list-group panel">
              <a href="home.php" class="list-group-item" data-toggle="collapse" data-parent="#MainMenu"><i class="material-icons">home</i>Home</a>
...
<div class="p" style="font-size:18px;"> 
	<div class="p">
		ParkWhizz App facilitates the online booking of slots. It has been designed to provide easy booking of slots in the parking lot of malls and other crowded places, much before entering the mall. One can book a slot for different time intervals. 
	</div>
	<br>
	<div><center><img src="carpark.png"></center></div>
	<br>
	<div class="p">
Each slot will have the following 4 statuses:
<ul>
<li> Vacant</li>
<li> Booked</li>
<li>Booked & Reported</li>
<li>Booked & Not Reported</li>
</ul>
</div>
	
	<div class="p">
Each slot will show a different status for different time intervals. The user can book a slot by mentioning the duration, and only if the status of that slot in that time interval is 'Vacant'.
	</div>
</div>
