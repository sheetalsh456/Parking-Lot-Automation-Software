...
$res1 = mysql_query("SELECT * FROM slot_details WHERE user_id = $id");
...
<div class="col-md-1">Slot No.</div>
<div class="col-md-1">Floor No.</div>
<div class="col-md-3">Slot Status</div>
<div class="col-md-2">Date</div>
<div class="col-md-2">Entry time</div>
<div class="col-md-2">Exit Time</div>
...
$y = $row1['year'];
$m = $row1['month'];
$slot_status = $row1['slot_status'];
$entryh = $row1['start_hour'];
$entrym = $row1['start_min'];
$endh = $row1['end_hour'];
$endm = $row1['end_min'];
$p = (((($endh-$entryh)*60)+($endm-$entrym))/60)*10;?>
<div class="row">
<div class="col-md-1"><?=$slot?></div>
<div class="col-md-1"><?=$floor?></div>
<div class="col-md-3"><?=$slot_status?></div>
<div class="col-md-2"><?=$d?> - <?=$m?> - <?=$y?></div>
<div class="col-md-2"><?=$entryh?> : <?=$entrym?></div>
<div class="col-md-2"><?=$endh?> : <?=$endm?></div>
<div class="col-md-1">Rs. <?=$p?></div>
</div>
<hr>
